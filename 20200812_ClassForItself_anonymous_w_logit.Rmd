...
Twitter_Tech <- readtext(file="Datasets/20200227_TwitterTechSES.csv", text_field="text.1")

#Reading in Twitter Population
Twitter_Pop <- readtext(file="Datasets/20190417_US_Final.csv", text_field="text.1")
```
...
#write.csv("Datasets/Residence_GeoCode.csv")
...
#save geolocation csv
#write.csv(Twitter_Tech, file="Datasets/Twitter_Tech.csv")
...
#ggsave("Plots/High Resolution/WorldMap.jpeg", height = 12, width = 21, units = 'cm', dpi = 300, plot = last_plot())
```
...
#tiff(file="Plots/High Resolution/TechCloud50.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#tiff(file="Plots/High Resolution/TechCloud100.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#basic wordcloud with 50 words
#tiff(file="Plots/High Resolution/PopCloud50.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#basic wordcloud with 100 words
#tiff(file="Plots/High Resolution/PopCloud100.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#write.csv(Twitter_both, file = "Datasets/Twitter_both.csv")
```
...
#Reading in LIWC Dictionary
liwc2015 <- quanteda::dictionary(file = "Datasets/dict.yml")
...
#keyness statistics
#tiff(file="Plots/High Resolution/KeynessTwitterFuture.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#keyness statistics
#tiff(file="Plots/High Resolution/KeynessTwitterMerit.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#keyness statistics
#tiff(file="Plots/High Resolution/KeynessTwitterAchieve.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
Pledge <- readtext(file="Datasets/GPMS.xlsx", text_field="pledge_letter")
...
#write.csv(Pledge, file = "Datasets/Pledge.csv")
...
```{r}
#basic wordcloud with 50 words
#tiff(file="Plots/High Resolution/PledgeCloud50.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#basic wordcloud with 100 words
#tiff(file="Plots/High Resolution/PledgeCloud100.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#basic wordcloud with 50 words
#tiff(file="Plots/High Resolution/PledgeTechNoTechCloud.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#tiff(file="Plots/High Resolution/PledgeTechCloud.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#tiff(file="Plots/High Resolution/PledgeNoTechCloud.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
```{r}
#keyness statistics
#tiff(file="Plots/High Resolution/KeynessPledgeTechNoTech.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
Mission <- readtext(file="Datasets/GPMS.xlsx", text_field="mission_statement")
...
#write.csv(Mission, file = "Datasets/Mission.csv")
```
...
```{r}
#basic wordcloud with 50 words
#tiff(file="Plots/High Resolution/MissionCloud50.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#basic wordcloud with 100 words
#tiff(file="Plots/High Resolution/MissionCloud100.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#basic wordcloud with 50 words
#tiff(file="Plots/High Resolution/MissionCloudCohort.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
#keyness statistics
#tiff(file="Plots/High Resolution/KeynessDemocracy.tiff", height = 12, width = 17, units = 'cm', compression = "lzw", res = 300)
...
##Naive Bayes Classifyer to predict whether Tweet is from Tech Elite vs. Population
```{r}
#install.packages("caret", dependencies = TRUE)
library(caret)

#generate random sample of 50% of the documents
set.seed(300)
id_train <- sample(1:99654, 49827, replace = FALSE)
head(id_train, 10)
...
###Support Vector Machine Classification with different sample sizes
...
set.seed(123)
tweets1000 <- Twitter_both[sample(nrow(Twitter_both), 1000),]

# clean text and create DFM
tweets1000$text <- gsub('@[0-9_A-Za-z]+', '@', tweets1000$text)
twcorpus <- corpus(tweets1000$text)
...
training <- sample(1:nrow(tweets1000), floor(.80 * nrow(tweets1000)))
test <- (1:nrow(tweets1000))[1:nrow(tweets1000) %in% training == FALSE]

fit <- tune(svm, train.x=twdfm[training,], 
            train.y=factor(tweets1000$dummy[training]),
            kernel="linear",
...
#bestmodel with 0.01 cost parameter
...
# confusion matrix
table(preds, tweets1000$dummy[test])
# performance metrics
accuracy(preds, tweets1000$dummy[test])
precision(preds, tweets1000$dummy[test])
recall(preds, tweets1000$dummy[test])

df <- data.frame(
  vector = tweets1000$text[training][bestmodel$index],
...
#write.svm(bestmodel, svm.file = "Models/SVM1000.svm", scale.file = "Models/SVM1000.scale", yscale.file = "Models/SVM1000.yscale")
...
preds <- predict(bestmodel, twdfm[test,])
# confusion matrix
table(preds, tweets50000$dummy[test])
# performance metrics
accuracy(preds, tweets50000$dummy[test])
precision(preds, tweets50000$dummy[test])
recall(preds, tweets50000$dummy[test])

df <- data.frame(
  vector = tweets50000$text[training][bestmodel$index],
  coef = bestmodel$coefs,
  stringsAsFactors = F
)
...
#write.svm(bestmodel, svm.file = "Models/SVM5000.svm", scale.file = "Models/SVM5000.scale", yscale.file = "Models/SVM5000.yscale")
```
